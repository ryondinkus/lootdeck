...
local HolographicDescriptions = {
    en_us = "Adds {{ColorRainbow}}2 copies of a{{CR}} unique passive item on use# Passive: On damage taken, lose 1 cent and fire a penny tear in a random direction# The penny tear has 2x damage and drops a Penny and a puddle of creep when it makes contact",
    spa = "Añade {{ColorRainbow}}2 copias de un{{CR}} objeto pasivo al usarla#Efecto pasivo: Al recibir daño, perderás y dispararás una moneda en una dirección aleatoria# Esta moneda hace tu daño x2 y genera tanto una moneda como un charco de Creep al hacer contacto"
}
